...
<div id="smartwizard">
    <ul class="nav nav-tabs" hidden>
        <li class="nav-item">
            <a class="nav-link " href="#step-2"> <strong>Clientes</strong>
            </a>
        </li>
    ...
    <div class="tab-content">
        ...
        <div id="step-2" class="tab-pane" role="tabpanel" aria-labelledby="step-2">
            <form action="{{route('financeiro.update',$reg->id)}}" method="POST">
                {{ csrf_field() }}
                @method('PUT')
                <div class="card">
                    <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col md-6">
                                                ...
                                                <div class="input-group" style="float: right;">
                                                    ...
                                                    <input value="{{$reg->value}}" class="form-control money" style="text-align: right;" id="value" value="" name="value" placeholder=""></input>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-6">
                                                ...
                                                <input value="{{$reg->readjustment}}" type="text" class="form-control" value="" id="readjustment" name="readjustment">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="early_warning" class="form-label">Aviso prévio</label>
                                                <input value="{{$reg->early_warning}}" type="text" class="form-control" value="" id="early_warning" name="early_warning">
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <input value="{{$reg->termination}}" type="text" class="form-control" value="" id="termination" name="termination">
                                            </div>

                                            <div class="col-6 mt-2">
                                                <label for="form_payment" class="form-label">Forma de pagamento </label>
                                                <select id="form_payment" name="form_payment" class="form-select">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <input value="{{$reg->contract_start}}" type="date" class="form-control" value="" id="contract_start" name="contract_start">
                                            </div>
                                            <div class="col-6 mt-2">
                                                <label for="contract_end" class="form-label">Término do contrato </label>
                                                <input type="text" class="form-control" value="{{$reg->contract_end}}" id="contract_end" name="contract_end" placeholder="Indeterminado"></input>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row mt-2">
                                            <div class="col ">
                                                ...
                                                <input class="form-control" value="{{$reg->response_finance}}" id="response_finance" name="response_finance" placeholder="Ex: Thiago Ventura"></input>
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col ">
                                                <label for="tel_finance" class="form-label">Telefone responsável</label>
                                                <input value="{{$reg->tel_finance}}" type="text" value="" class="form-control phone_with_ddd" id="tel_finance" name="tel_finance" placeholder="(00)00000-0000"></input>
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col mt-2 ">
                                                <label for="email_finance" class="form-label">E-mail responsável</label>
                                                <input type="text" value="{{$reg->email_finance}}" class="form-control" id="email_finance" name="email_finance" placeholder="email@email.com"></input>
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col mt-2 ">
                                                <label for="dt_payment" class="form-label">Data de pagamento </label>
                                                <input type="date" value="{{$reg->dt_payment}}" class="form-control" id="dt_payment" name="dt_payment"></input>
                                            </div>
                                        </div>
                                    </div>
                                </div>
