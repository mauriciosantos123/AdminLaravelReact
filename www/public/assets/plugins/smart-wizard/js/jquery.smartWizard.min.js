            ...
            return _createClass(s, [{
                ...
                value: function () {
                    ...
                    switch (this.options.toolbarSettings.toolbarPosition) {
                        ...
                        case "bottom":
                            ...
                            break;
                        case "both":
                            this.container.before(this._createToolbar("top")), this.container.after(this._createToolbar("top"));
                            break;
                        default:
                            this.container.after(this._createToolbar("bottom"))
                    }
                ...
                value: function (t) {
                    ...
                    var s = v("<div></div>").addClass("toolbar toolbar-" + t).attr("role", "toolbar"),
                        e = !1 !== this.options.toolbarSettings.showNextButton ? v("").text(this.options.lang.next).addClass("btn sw-btn-next").attr("type", "button") : null,
                        i = !1 !== this.options.toolbarSettings.showPreviousButton ? v("").text(this.options.lang.previous).addClass("btn sw-btn-prev").attr("type", "button") : null;
                ...
                value: function (t, e) {
                    ...
                    switch (this._stopAnimations(), o) {
                        ...
                        case "slide-vertical":
                        case "slide-v":
                            var c, p, d = this.container.height(),
                                f = d,
                                _ = -2 * d;
