...
(function ($, window, document, undefined) {
	...
	$.fn.imageuploadify = function (opts) {
		...
		this.each(function () {
			...
			<div class="imageuploadify-overlay"></div>
				<div class="imageuploadify-images-list text-center"><i class="bx bxs-cloud-upload"></i> 
					<div class="col-sm"><button type="button"class="btn btn-default text-center">Arraste ou selecione o arquivo</button>
					</div>
				</div>
			</div>`);
			...
			const readingFile = (id, file) => {
				...
				let container = $(`
				<div class='imageuploadify-container'><button type='button'class='btn btn-danger bx bx-x'></button>
					<div class='imageuploadify-details'><span>${file.name}</span>
						<span>${file.type}</span>
						<span>${file.size}</span>
					</div>
				</div>`);
